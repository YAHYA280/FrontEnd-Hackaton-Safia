...
import { Sparkles, MapPin, Calendar, Lightbulb, ArrowRight, Map, Palette, Shield } from "lucide-react";

export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-100 dark:from-slate-950 dark:via-orange-950/20 dark:to-slate-900">
      {/* Background Effects */}
      <FloatingOrbs />
      <MoroccanDecorations />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center space-y-8">
            ...
            <div className="animate-fade-in-up inline-flex items-center gap-2 glass rounded-full px-4 py-2 text-sm">
              ...
              <span className="text-foreground/80">AI-Powered Travel Planning</span>
            </div>

            {/* Main Heading */}
            <h1 className="animate-fade-in-up delay-100 text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight">
              <span className="block text-foreground">Discover the Magic of</span>
              <span className="block text-gradient-primary mt-2">Morocco with AI</span>
            </h1>

            {/* Subheading */}
            <p className="animate-fade-in-up delay-200 mx-auto max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed">
              Plan your perfect Moroccan adventure with intelligent recommendations,
            ...
            <div className="animate-fade-in-up delay-300 flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/plan-trip">
                <Button size="lg" className="glow-primary-hover group text-base px-8 py-6">
                  Start Planning
                  <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                </Button>
              </Link>
              <Link href="/signin">
                <Button size="lg" variant="outline" className="glass-strong hover-glow text-base px-8 py-6">
                  Sign In
                </Button>
              </Link>
            </div>
            ...
            <div className="animate-fade-in-up delay-400 pt-12 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={index} className="glass-card rounded-2xl p-6 hover:scale-105 transition-transform">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Experience Morocco like never before with intelligent travel planning
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Generate detailed day-by-day plans optimized for your preferences and time.",
                color: "from-blue-500 to-blue-600",
              },
              {
                icon: MapPin,
                title: "Local Experiences",
                description: "Discover hidden gems and authentic Moroccan culture beyond tourist spots.",
                color: "from-green-500 to-green-600",
              },
              {
                icon: Calendar,
                title: "Smart Scheduling",
                description: "Optimize your time with intelligent routing and activity recommendations.",
                color: "from-purple-500 to-purple-600",
              },
              {
                icon: Palette,
                title: "Cultural Immersion",
                description: "Connect with Moroccan traditions, art, gastronomy, and local communities.",
                color: "from-pink-500 to-pink-600",
              },
              {
                icon: Shield,
                title: "Safe & Verified",
                description: "All recommendations are verified and updated for your safety and comfort.",
                color: "from-teal-500 to-teal-600",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="group glass-card rounded-3xl p-8 hover:scale-105 transition-all duration-300 animate-fade-in-scale"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="relative mb-6">
                  <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${feature.color} opacity-90`}>
          ...
          <div className="glass-strong rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of travelers who have discovered the magic of Morocco
                with personalized AI-powered itineraries.
              </p>
              <Link href="/plan-trip">
                <Button size="lg" className="glow-primary-hover group text-lg px-10 py-7">
                  Plan Your Trip Now
